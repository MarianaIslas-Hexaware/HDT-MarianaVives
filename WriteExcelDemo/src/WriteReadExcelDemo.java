...
public class WriteReadExcelDemo {
	public static void main (String []args) {
		//1. Crear mi workbook en blanco
			XSSFWorkbook workbook = new XSSFWorkbook();
		     
		//2. Crear una hoja de excel
		    XSSFSheet sheet = workbook.createSheet("Ejercicio");
		
		//3. Escribir los datos que vamos a nuestra hoja de Excel (Object[])
		...
		//4. Iterar los datos y escribir sobre la hoja de excel
